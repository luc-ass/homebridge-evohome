...
Session.prototype.setHeatSetpoint = function (zoneId, targetTemperature, endtime) {
    ...
    if(endtime != null) {
        ...
        /// remove logging before release!
        console.log("called for temporary override")
        ...
        /// remove logging before release!
        console.log("called to follow the schedule");
        var body = JSON.stringify({"HeatSetpointValue":0.0,"SetpointMode":"FollowSchedule","TimeUntil":null});
    } else {
        // if target temperature is null we ask for a permanent override of the schedule
        /// remove logging before release!
        console.log("called for permanent override");
