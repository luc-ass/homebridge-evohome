...
//TODO: have a multiswitch instead, and maybe remove code duplicate
Session.prototype.setHotWaterMode = function (systemId, dhwState) {
  var deferred = Q.defer();
...
Session.prototype.setSystemMode = function (systemId, systemMode, isHotWater) {
  ...
  //TODO: change this to multiswitch
  if (isHotWater) {
    var url = "https://tccna.honeywell.com/WebAPI/emea/api/v1/domesticHotWater/" +
      systemId +
      "/state";
