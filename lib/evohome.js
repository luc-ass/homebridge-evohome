...
Session.prototype.getSchedule = function (zoneId) {
  var url = `${BASE_URL}/WebAPI/emea/api/v1/temperatureZone/${zoneId}/schedule`;
...
Session.prototype.getThermostats = function (locationId) {
  var url = `${BASE_URL}/WebAPI/emea/api/v1/location/${locationId}/status?includeTemperatureControlSystems=True`;
  return this._request(url).then(function (json) {
    return _.map(
...
Session.prototype.getLocations = function () {
  var url = `${BASE_URL}/WebAPI/emea/api/v1/location/installationInfo?userId=${this.userInfo.userID}&includeTemperatureControlSystems=True`;
  return this._request(url).then(function (json) {
...
Session.prototype.setHeatSetpoint = function (
  ...
  var url = `${BASE_URL}/WebAPI/emea/api/v1/temperatureZone/${zoneId}/heatSetpoint`;
  var now = new Date();
...
Session.prototype.setSystemMode = function (systemId, systemMode) {
  var deferred = Q.defer();
  var url = `${BASE_URL}/WebAPI/emea/api/v1/temperatureControlSystem/${systemId}/mode`;
...
function getUserInfo(json) {
  ...
  request(
    {
      method: "GET",
      url: `${BASE_URL}/WebAPI/emea/api/v1/userAccount`,
      headers: {
